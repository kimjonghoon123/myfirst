...
class SeleniumMiddleware(object):
    ...
    def process_request(self, request, spider):
        ...
        element = self.driver.find_element_by_name("query")
        element.send_keys("항만 뉴스")
        element.submit()
        self.driver.find_element_by_xpath('//*[@id="lnb"]/div[1]/div/ul/li[7]/a').click()
        sleep(2)
        body = to_bytes(text=self.driver.page_source)
        print("가능")
        yield HtmlResponse(url=request.url, body=body, encoding='utf-8', request=request)
...
class NewsdDownloaderMiddleware:
    # Not all methods need to be defined. If a method is not defined,
